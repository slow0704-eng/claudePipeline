...
INSERT INTO categories (id, name, description, display_order, enabled, created_at) VALUES
...
INSERT INTO comments (id, board_id, user_id, nickname, content, parent_comment_id, created_at, is_deleted, like_count) VALUES
...
-- Bookmarks (users bookmarks interesting posts)
INSERT INTO bookmarks (user_id, board_id, created_at) VALUES
-- 김개발 bookmarks
